...
/**
 * Created by pipob on 29/06/2016.
 */
public class WeatherDataParser {
    ...
    public static String getMaxTemperatureForDay(String weatherJsonStr,int dayIndex) throws JSONException{
        JSONObject weather = new JSONObject(weatherJsonStr);
        JSONArray days = weather.getJSONArray("list");
        JSONObject dayinfo = days.getJSONObject(dayIndex);
        JSONObject mainInfo = dayinfo.getJSONObject("main");
        String temperatureInfo = mainInfo.getString("temp_max");
    ...
    public String[] getWeatherDataFromJson(String forecastJsonStr, int numDays,String unitType)
        ...
        for(int i = 0; i < weatherArray.length(); i++) {
            ...
            try{
                ...
                JSONObject mainInfo = dayForecast.getJSONObject("main");
                ...
                Double temperature = mainInfo.getDouble(OWM_TEMPERATURE);
                double high = mainInfo.getDouble(OWM_MAX);
